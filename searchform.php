...
<?php }else{ ?>
	...
	<i class="fas fa-search search-icon"></i>
	<input type="search" title="search" class="search-field" placeholder="Search This Site" name="q" value="<?php echo isset($_GET['q']) ? wp_filter_nohtml_kses(sanitize_text_field($_GET['q'])) : ""; ?>">
	<button type="submit" class="search-button">Search
	</button>
	<button type="button" class="clear-button">
	<i class="fa-regular fa-circle-xmark" aria-label="Clear"></i>
