<?php
/*
 * purdue-home-theme Navwalker
 *
 * @package purdue-home-theme
 */
if ( ! class_exists( 'purdueHome_nav_mainlMenu' ) ) {
	class purdueHome_nav_mainlMenu extends Walker_Nav_Menu {
...
if ( ! class_exists( 'purdueHome_nav_footerSocial' ) ) {
	class purdueHome_nav_footerSocial extends Walker_Nav_Menu {
